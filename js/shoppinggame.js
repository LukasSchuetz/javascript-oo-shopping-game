...
const player = {
    ...
    score,
    items,
    getCurrentScore: function () { return this.score },
    deductPoints: function (points) { this.score -= points },
    addPoints: function (points) { this.score += points }
...
Object.defineProperty(Product, 'daysToExpire', {
    get: function() {
        ...
        const test = dateDiff(this.expiryDate, new Date());
        return test;
    }
})
